...
init_file = os.path.join(base_path, 'pycsldv', '__init__.py')
...
if __name__ == '__main__':
    setup(
        name='pyCSLDV',
        description='Continuous scanning laser Doppler vibrometry (CSLDV).',
        ...
        keywords=['CSLDV', 'LDV', 'vibrometry', 'structural dynamics'],
        packages=['pycsldv'],
